...
const navigate=useNavigate()
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-black to-blue-800 
    ...
    <span className='text-blue-200'> Assistant Image</span></h1>
      ...
      <Card image={image6} />
      <Card image={image7} />
              <div className={`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-blue-950 border-2 border-blue-900
