    ...
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center'
      ...
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000050] backdrop-blur
        ...
        <input type="text" placeholder='Enter your Name' className='w-full
                ...
                text-[18px]' required onChange={(e) => setName(e.target.value)}
          value={name} />

        <input type="email" placeholder='Email' className='w-full
                h-[60px] outline-none border-2 border-white bg-transparent
                text-white placeholder-gray-300 px-[20px] py-[10px] rounded-full
                text-[18px]'onChange={(e) => setEmail(e.target.value)}
          value={email} />
        <div className='w-full h-[60px] border-2 border-white bg-transparent
          ...
          <input type={showPassword ? "text" : "password"} placeholder='Password' className='w-full
                h-full rounded-full outline-none bg-transparent placeholder-gray-300
                 px-[20px] py-[10px]' onChange={(e) => setPassword(e.target.value)}
            value={password} />
        ...
        <p className='text-white text-[18px] cursor-pointer'
          onClick={() => navigate("/signin")}>Already have an account? <span
