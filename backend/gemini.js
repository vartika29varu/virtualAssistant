...
try {
    ...
    Your task is to understand the user's natural language input and respond a JSON
    object like this:
    ...
    and agar kisi ne google ya youtube pe kuch search karne ko bola hai to userInput 
    ...
    aur agar koi aisa question puchta hai jiska answer tumhe pata hai usko bhi 
